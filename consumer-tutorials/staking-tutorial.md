---
description: This tutorial will explain how to delegate/stake/unstake your PYZ.
---

# Staking tutorial

Note: You can only stake PYZ which is on PYZ Blockchain network. Please make sure you have changed into PYZ Blockchain network in Metamask while doing any transactions on staking UI. 

How to Stake PYZ Blockchain:

**Step 1:**

Navigate to staking.payscan.live and login to your wallet through metamask. Make sure you are on PYZ Blockchain network. If you are not please follow the instructions [**here**](https://doc.payscan.live/the-PYZ-studio/getting-started/how-to-add-PYZ-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of PYZ you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 
