...
## PYZ-studio-backend v0.1.0

The PYZ Blockchain Studio REST API for accessing the data and the services of the PYZ Blockchain network in a simple way. You can use this API to query and interact with the objects of the PYZ Blockchain network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and PYZ Blockchain network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(PYZ Blockchain\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the PYZ Blockchain network |
...
| homeBridgeAddress | `String` | Bridge address on the PYZ Blockchain network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the PYZ Blockchain network |
...
Community is a set of contracts and services. Members of the community are users of the PYZ Blockchain network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the PYZ Blockchain network |
| homeTokenAddress | `String` | Address of the community token on the PYZ Blockchain network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the PYZ Blockchain network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the PYZ Blockchain network |
...
Entity is an account on the PYZ Blockchain network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on PYZ Blockchain network |
...
Tokens are compatible with the PYZ20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
...
| networkType | `String` | Network type where the token is issued: mainnet/ropsten/PYZ |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| networkType | `String` | mainnet/ropsten/PYZ |
| page | `Number` | Page number for pagination |
