...
[Learn more about Media Block Network Coin](https://doc.payscan.live/become-a-validator/how-to-become-a-validator)
...
****[Learn more about Media Block Network Coin Studio](https://doc.payscan.live/the-Media Block Network-studio/overview)
...
[Learn more about Media Block Network Coin wallet](https://doc.payscan.live/the-mobile-wallet/overview)  
****
...
Check out our featured live micro-economies launched on Media Block Network Coin: [https://studio.payscan.live/view/communities](https://studio.payscan.live/view/communities)

## **What is the purpose of the Media Block Network Coin token?** 

The Media Block Network Coin token aka Media Block Network is the internal currency of the Media Block Network Coin.  Those validating the network are paid in Media Block Network. This aligns the incentives between the validators and the network users. Learn more about Media Block Network tokenomics: [https://doc.payscan.live/the-Media Block Network-chain/Media Block Network-token](https://doc.payscan.live/the-Media Block Network-chain/Media Block Network-token)
