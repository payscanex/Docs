---
description: Steps on deploying a smart contract on PYZnet through Remix.
---

# Deploying smart contract on PYZnet

PYZ Blockchain is an EVM compatible network, every tool for Ethereum can be used for the PYZ Blockchain network too.
...
Since we interact with remix using Metamask, you need to change the network to PYZ Blockchain network by adding a custom RPC. Please follow the steps in [this tutorial](https://doc.payscan.live/the-PYZ-studio/getting-started/how-to-add-PYZ-to-your-metamask) to do that.

You need to have a small balance of PYZ on the PYZnet wallet you are using which will be used as Gas for the transactions.
